...
function LoginModal() {
  return (
    <div className="modal w-4/6 bg-primary flex flex-row h-[568px]">
      ...
      <div className="w-1/2 h-full hidden md:flex flex-col justify-between">
        <div className="flex flex-col w-full items-center my-auto select-none">
          <img src="/logo_anijp.svg" alt="" className="w-32" />
          <h1 className="text-white md:text-3xl lg:text-5xl font-bold">
            Music For Life
          </h1>
        </div>
        <div className="relative h-2/3 select-none">
          <img
            src="/images/chara.png"
            alt=""
            className="w-1/2 h-full absolute bottom-0 right-0"
          />
          <div className="absolute md:-left-16 lg:left-0 bottom-10">
            <svg
              width="300"
              height="300"
              viewBox="0 0 506 507"
